    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Content-Security-Policy', value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://js.stripe.com https://clerk.flashback-restore.com https://challenges.cloudflare.com; style-src 'self' 'unsafe-inline' https://clerk.flashback-restore.com https://img.clerk.com; img-src 'self' data: blob: https: https://img.clerk.com https://clerk.flashback-restore.com; frame-src https://js.stripe.com https://clerk.flashback-restore.com https://challenges.cloudflare.com; connect-src 'self' https://api.stripe.com https://clerk.flashback-restore.com https://challenges.cloudflare.com; font-src 'self' data: https://clerk.flashback-restore.com https://img.clerk.com; worker-src 'self' blob:" },
        ],
      },
    ];
  },
