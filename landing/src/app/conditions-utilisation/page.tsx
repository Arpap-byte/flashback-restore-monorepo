...
const sections = [
  ...
  {
    icon: CreditCard,
    title: "6. Conditions de paiement et abonnements",
    content: "",
    bullets: [
      ...
      "Les abonnements sont renouvelés automatiquement. Vous pouvez résilier à tout moment depuis votre espace client en quelques clics, sans avoir à nous contacter.",
      "Conformément à l'article L.221-28 du Code de la consommation, vous renoncez expressément à votre droit de rétractation de 14 jours pour la fourniture immédiate de contenu numérique.",
    ],
  },
  {
    icon: Ban,
