    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-1 pt-28 pb-16 flex items-center justify-center">
        ...
        <div className="fixed inset-0 pointer-events-none">
          <div className="absolute top-1/3 left-1/4 w-[700px] h-[700px] bg-emerald-600/5 rounded-full blur-[130px]" />
        ...
        <div className="relative z-10 max-w-lg mx-auto px-4 sm:px-6 text-center">
          ...
          >
            ...
            <p className="text-muted text-lg mb-10 max-w-md mx-auto">
              Votre compte est maintenant prêt. Vous pouvez accéder à toutes les
              fonctionnalités depuis votre tableau de bord.
            </p>
